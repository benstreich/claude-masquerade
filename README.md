...
| `/write-persona <name or description>` | Claude writes a new curated character for you — see below |
...
`/write-persona gordon ramsay` — or `/write-persona a grumpy 1970s unix greybeard` — makes Claude write a full voice file in the template format and save it **user-locally**:
